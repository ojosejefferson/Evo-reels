...
const ProductDetailsPanel = ({ productsData = {}, onClose }) => {
	...
	return (
		...
		>
			...
			<div className="evo-reels-modal fixed bottom-[-100%] left-0 w-full h-full bg-white rounded-t-[32px] p-5 transition-all duration-400 ease-in-out shadow-xl z-[999] overflow-y-auto" id="modal2">
				<div className="flex justify-between items-center pb-2">
					<button 
						className="back-btn bg-none border-none text-xl cursor-pointer p-2 font-bold" 
						onClick={(e) => {
